...
def htmlTop():
        ...
        <head>
            ...
            <title>Subscription | Fresh</title>
                        ...
                        <div class="container clearfix">
                            ...
                            <nav id="primary-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="main/recipes/recipes.html"><div>Recipes <i class="fa fa-angle-down"></i></div></a>
                                        <ul class="rounded-bottom">
                                            <li><a href="main/recipes/recipes.html"><div>Popular</div></a></li>
                                            <li><a href="main/recipes/recipes.html"><div>Recent</div></a></li>
                                            <li><a href="main/recipes/recipes.html"><div>Most liked</div></a></li>
                                            <li><a href="main/recipes/recipes.html"><div>Most Commented</div></a></li>
                                        </ul>
                                    </li>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 offset-2 center">
                                        <h2 class="text-title-light text-dark mb-5 ls1 uppercase">Thank you for subscribing!</h2>
                                        <p style="font-size: 17px; color: #777"> Welcome to the family! You will be updated by the Fresh Team with weekly emails including Recipes of the Week and Recommended for You Recipes. <br><br>Cheers to all your cooking endeavors!</p>
...
def getData():
    ...
    email = form.getvalue("subscribe")

    email_file = open("email-list.txt", "a")
